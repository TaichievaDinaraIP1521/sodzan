...
<head>
    ...
    <meta property="og:description" content="Просим вас пройти предварительную регистрацию для участия в проекте реализуемом Институтом профессионального образования (ИРПО)">
...
<body>
    <div class="upper">
      ...
      <div class="img"><a href="php/users.php"><img src="images/profile.png" alt=""></a></div>
    </div>
    <div class="inner">
